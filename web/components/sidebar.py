...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        llm_provider = st.selectbox(
            "LLM提供商",
            options=["dashscope", "deepseek", "google", "openrouter", "azureopenai"],
            index=["dashscope", "deepseek", "google", "openrouter", "azureopenai"].index(st.session_state.llm_provider) if st.session_state.llm_provider in ["dashscope", "deepseek", "google", "openrouter", "azureopenai"] else 3,
